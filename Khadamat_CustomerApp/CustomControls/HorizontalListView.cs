...
namespace Khadamat_CustomerApp.CustomControls
{
    public class HorizontalListView : Grid
    {
        ...
        public static readonly BindableProperty CommandProperty =
            BindableProperty.Create<HorizontalListView, ICommand>(p => p.Command, null);
        ...
        public static readonly BindableProperty SelectedItemProperty =
            BindableProperty.Create<HorizontalListView, object>(p => p.SelectedItem, default(object), BindingMode.TwoWay, null, OnSelectedItemChanged);

        public static readonly BindableProperty ItemTemplateProperty =
            BindableProperty.Create<HorizontalListView, DataTemplate>(p => p.ItemTemplate, default(DataTemplate));
